    ...
    : QMainWindow(parent)
{
    ...
    ui.comboBox_1->addItems(QStringList() << QString::fromLocal8Bit("男") << QString::fromLocal8Bit("女"));
...
;
    ...
    ui.label->setText(QString::fromLocal8Bit("今日目标：") + QString::number(allneed) + "ML");
